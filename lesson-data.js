  ...
  const LESSONS = {
    ...
    "lesson-4": {
      ...
      pages: [
        ...
        { page: 2, slug: "lesson-4-page-2", title: "Language Study", template: "grammar" },
        { page: 3, slug: "lesson-4-page-3", title: "Culture and History / Final Quiz", template: "culture" }
      ],
      vocabulary: [
        {
          category: "Nouns",
          items: [
            { greek: "ὁ ἱππεύς", english: "cavalryman", status: "new required vocabulary", dictionaryForm: "ἱππεύς, ἱππέως, ὁ", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "τὸ κράνος", english: "helmet", status: "new required vocabulary", dictionaryForm: "κράνος, κράνους, τό", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "ὁ θώραξ", english: "cuirass", status: "new required vocabulary", dictionaryForm: "θώραξ, θώρακος, ὁ", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
        ...
        },
        {
          category: "Verbs",
          items: [
            { greek: "θεωρέω", english: "observe, inspect", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "ψήχω", english: "brush, groom", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "καθαίρω", english: "clean", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "μέλλω", english: "be about to", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } },
            { greek: "ἀναβαίνω", english: "mount", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } }
          ]
        },
        {
          category: "Adjective",
          items: [
            { greek: "ἐπιμελής", english: "careful, diligent", status: "new required vocabulary", dictionaryForm: "ἐπιμελής, ἐπιμελές", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } }
          ]
        },
        {
          category: "Adverb",
          items: [
            { greek: "προθύμως", english: "eagerly, willingly", status: "new required vocabulary", audioPlaceholder: true, spacedRepetition: { box: 1, intervalDays: 0, ease: 2.5 } }
          ]
        }
      ],
      reading: {
      ...
      ...LESSON_4_LANGUAGE_STUDY,
      culture: LESSON_4_CULTURE_QUIZ.culture,
      activities: { ...LESSON_4_LANGUAGE_STUDY.activities, ...LESSON_4_CULTURE_QUIZ.activities },
      previousLesson: {
        id: "lesson-3",
        title: "The Education of Xenophon",
        fallbackUrl: "lesson.html?lesson=3&page=1"
  ...
  function getVocabularyCards(lesson) {
    return (lesson?.vocabulary || []).flatMap((group) =>
      group.items.map((item) => ({
        ...
        ...(item.audioPlaceholder ? { audioPlaceholder: true } : {}),
        ...(item.spacedRepetition ? { spacedRepetition: item.spacedRepetition } : {})
      }))
    );
  }
